...
public class SpecialMissionFragment extends Fragment {
    ...
    private LinearLayout linearQ1, linearQ2, linearQ3, linearQ4;
    ...
    public void onCreate(@Nullable  Bundle savedInstanceState) {
        ...
        missionsSpecViewModel = new ViewModelProvider(this).get(MissionsSpecViewModel.class);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q1a1.setText(Html.fromHtml(mixedAns1.get(0), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q1a2.setText(Html.fromHtml(mixedAns1.get(1), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q1a3.setText(Html.fromHtml(mixedAns1.get(2), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q1a4.setText(Html.fromHtml(mixedAns1.get(3), HtmlCompat.FROM_HTML_MODE_LEGACY));

        q2a1.setText(Html.fromHtml(mixedAns2.get(0), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q2a2.setText(Html.fromHtml(mixedAns2.get(1), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q2a3.setText(Html.fromHtml(mixedAns2.get(2), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q2a4.setText(Html.fromHtml(mixedAns2.get(3), HtmlCompat.FROM_HTML_MODE_LEGACY));

        q3a1.setText(Html.fromHtml(mixedAns3.get(0), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q3a2.setText(Html.fromHtml(mixedAns3.get(1), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q3a3.setText(Html.fromHtml(mixedAns3.get(2), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q3a4.setText(Html.fromHtml(mixedAns3.get(3), HtmlCompat.FROM_HTML_MODE_LEGACY));

        q4a1.setText(Html.fromHtml(mixedAns4.get(0), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q4a2.setText(Html.fromHtml(mixedAns4.get(1), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q4a3.setText(Html.fromHtml(mixedAns4.get(2), HtmlCompat.FROM_HTML_MODE_LEGACY));
        q4a4.setText(Html.fromHtml(mixedAns4.get(3), HtmlCompat.FROM_HTML_MODE_LEGACY));
