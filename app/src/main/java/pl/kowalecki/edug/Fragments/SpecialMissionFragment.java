...
public class SpecialMissionFragment extends Fragment {
    ...
    private TextView codename, missionStart, introText, question1, question2, question3, question4;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        q1a1.setText(mixedAns1.get(0));
        q1a2.setText(mixedAns1.get(1));
        q1a3.setText(mixedAns1.get(2));
        q1a4.setText(mixedAns1.get(3));

        q2a1.setText(mixedAns2.get(0));
        q2a2.setText(mixedAns2.get(1));
        q2a3.setText(mixedAns2.get(2));
        q2a4.setText(mixedAns2.get(3));

        q3a1.setText(mixedAns3.get(0));
        q3a2.setText(mixedAns3.get(1));
        q3a3.setText(mixedAns3.get(2));
        q3a4.setText(mixedAns3.get(3));

        q4a1.setText(mixedAns4.get(0));
        q4a2.setText(mixedAns4.get(1));
        q4a3.setText(mixedAns4.get(2));
        q4a4.setText(mixedAns4.get(3));
